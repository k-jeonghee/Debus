import { useMessageMutation } from '@hooks/services/mutations/chat';
...
const ChatForm = () => {
    ...
    const { mutate } = useMessageMutation(chatRoomId);

    const handleCreateMessage: SubmitHandler<FormData> = (data) => {
